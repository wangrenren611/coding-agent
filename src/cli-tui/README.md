...
### Web Terminal Container (No Scrollbar)

If you want an OpenCode-like embedded terminal shell (instead of system terminal UI scrollbars):

```bash
pnpm dev:cli-tui-webterm
```
...
- `CLI_TUI_WEBTERM_HOST` (default: `127.0.0.1`)
- `CLI_TUI_WEBTERM_PORT` (default: `3210`)
- `CLI_TUI_WEBTERM_CMD` (default: `bun run src/cli-tui/index.tsx`)
