...
export function Home() {
    ...
    return (
        <box flexDirection="column" width="100%" height="100%" flexGrow={1} backgroundColor={theme.background}>
            {/* 顶栏 */}
            <box
                width="100%"
                flexDirection="row"
            ...
            <box
                ...
                flexShrink={0}
            >
                <Prompt ref={promptRef} onSubmit={() => void 0} />
            </box>
            ...
            >
                ...
                <text fg={theme.textMuted}>session: {agent.state.currentSessionId?.slice(-1, 8) ?? 'new'}</text>
            </box>
        </box>
    );
}
